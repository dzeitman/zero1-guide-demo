//
//  Zero1_GenericListViewController.m
//  Zero1BiennalDemo
//
...
#import "Zero1_GenericListViewController.h"
#import "Zero1_GenericListViewCell.h"

@interface Zero1_GenericListViewController ()

@end

@implementation Zero1_GenericListViewController
@synthesize data;
...
- (void)viewDidLoad
{
    ...
    // reference mainMenuData from app delegate
    Zero1_AppDelegate *AppDelegate =  [[UIApplication sharedApplication] delegate];	
    self.data = AppDelegate.mainMenuData;
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    // Configure the cell...
    cell.textLabel.text = [[self.data objectAtIndex:indexPath.row] capitalizedString];
