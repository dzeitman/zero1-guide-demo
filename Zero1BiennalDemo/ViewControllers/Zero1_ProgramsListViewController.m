//
//  Zero1_ProgramsListViewController.m
//  Zero1BiennalDemo
//
...
#import "Zero1_ProgramsListViewController.h"
#import "Zero1_GenericListViewCell.h"

@interface Zero1_ProgramsListViewController ()

@end

@implementation Zero1_ProgramsListViewController
@synthesize data;
...
- (void)viewDidLoad
{
    ...
    self.data = AppDelegate.programs;
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    // Configure the cell...
    cell.textLabel.text = [[listItem objectForKey:@"programname"]capitalizedString];
