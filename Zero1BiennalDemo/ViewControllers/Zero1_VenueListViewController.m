//
//  Zero1_VenueListViewController.m
//  Zero1BiennalDemo
//
...
#import "Zero1_VenueListViewController.h"

@interface Zero1_VenueListViewController ()

@end

@implementation Zero1_VenueListViewController
@synthesize data;
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    // Configure the cell...
    cell.textLabel.text = [[listItem objectForKey:@"venuename"]capitalizedString];
